...
worker_two_GT = json.load(open("../../../datasets/HateSPic/MMHS/anns/MMHS50K_GT_worker1.json"))
worker_three_GT = json.load(open("../../../datasets/HateSPic/MMHS/anns/MMHS_5K_GT_worker3.json"))
    ...
    try:
        ...
        if v['label'] == 0:
            ...
            if v2['label'] > 0 and v3['label'] > 0:
                ...
                ids_disagreed.append(k)
            if v2['label'] == v['label'] and v3['label'] == v['label']:
